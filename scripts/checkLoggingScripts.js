var checkLogging = function() {
    ...
    if (username == "" || password == "") {
        $('#wrongPasswordAlert').remove();
            var text = "<div class=\"alert alert-warning alert-dismissible fade show\" id=\"wrongPasswordAlert\"> \
                            <strong>Aviso!</strong> Introduzca un Usuario y una Contraseña \
                            <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\"></button> \
                        </div>";
            $('#wrongUser').append(text);
    } else {
        $.getJSON('../data/accounts.json', function(cuentas) {
